...
export type Class = {
  authority: Address;
  isFrozen: boolean;
  credentialAccount: Option<Address>;
  name: string;
  metadata: string;
};
...
export type ClassArgs = {
  authority: Address;
  isFrozen: boolean;
  credentialAccount: OptionOrNullable<Address>;
  name: string;
  metadata: string;
};
...
export function getClassEncoder(): Encoder<ClassArgs> {
  return getStructEncoder([
    ...
    ['credentialAccount', getOptionEncoder(getAddressEncoder())],
...
export function getClassDecoder(): Decoder<Class> {
  return getStructDecoder([
    ...
    ['credentialAccount', getOptionDecoder(getAddressDecoder())],
