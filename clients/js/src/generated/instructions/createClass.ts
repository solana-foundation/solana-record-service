...
import { SRS_PROGRAM_ADDRESS } from '../programs';
import { getAccountMetaFactory, type ResolvedAccount } from '../shared';

export const CREATE_CLASS_DISCRIMINATOR = 1;
...
export type CreateClassInstruction<
  TProgram extends string = typeof SRS_PROGRAM_ADDRESS,
...
export type CreateClassInstructionDataArgs = CreateClassInstructionData;
...
export function getCreateClassInstruction<
  ...
  TAccountClass extends string,
  TAccountSystemProgram extends string,
  TProgramAddress extends Address = typeof SRS_PROGRAM_ADDRESS,
>(
...
> {
  // Program address.
  const programAddress = config?.programAddress ?? SRS_PROGRAM_ADDRESS;
