...
pub const CREATE_CLASS_DISCRIMINATOR: u8 = 0;
...
impl CreateClass {
    pub fn instruction(&self, args: CreateClassInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = CreateClassInstructionData::new().try_to_vec().unwrap();
...
impl CreateClassInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
impl CreateClassBuilder {
    ...
    #[inline(always)]
    pub fn name(&mut self, name: U8PrefixedStr) -> &mut Self {
        self.name = Some(name);
        self
    }
    #[inline(always)]
