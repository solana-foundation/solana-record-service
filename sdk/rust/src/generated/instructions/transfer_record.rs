...
pub const TRANSFER_RECORD_DISCRIMINATOR: u8 = 7;
...
impl TransferRecord {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = TransferRecordInstructionData::new().try_to_vec().unwrap();
...
impl TransferRecordInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
impl TransferRecordBuilder {
    ...
    #[inline(always)]
    pub fn new_owner(&mut self, new_owner: Address) -> &mut Self {
