...
pub const MINT_TOKENIZED_RECORD_DISCRIMINATOR: u8 = 10;
...
pub struct MintTokenizedRecord {
    ...
    pub group: solana_address::Address,
...
impl MintTokenizedRecord {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = MintTokenizedRecordInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct MintTokenizedRecordBuilder {
    ...
    group: Option<solana_address::Address>,
...
impl MintTokenizedRecordBuilder {
    ...
    /// Group account for the tokenized record
    #[inline(always)]
    pub fn group(&mut self, group: solana_address::Address) -> &mut Self {
